  ...
  return (
    ...
    >
      <div className="bg-white 2xl:w-[65%] xl:w-[75%] w-[85%] mx-auto relative flex flex-row h-[90%] outline-none ring-0">
        <div className="w-[65%] pl-5 pr-2 pt-10">
          ...
          <div className="h-[95%] overflow-y-scroll pb-14 pt-4">
            ...
            {showShippingForm ? (
              ...
              <ShippingInfo editShipping={() => setShowShippingForm(true)} />
            )}
            {!showShippingForm && (
              <>
                ...
                <div
                  className={`px-4 py-4 mt-2 rounded bg-appGray2 ${
                ...
                <div
                  className={`px-4 py-4 mt-2 rounded bg-appGray2 ${
                    activeMethod === "wallet" ? "border border-appBlue" : ""
                  } cursor-pointer`}
        ...
        <div className="w-[35%] bg-appGray2 px-4 relative">
          ...
          <p className="uppercase text-[14px] font-medium tracking-wider pb-6">
            order summary
          </p>
          ...
          <div className="absolute bottom-0 h-[100px] w-full left-0 px-4 bg-appGray2 flex flex-col justify-center">
            <button className="py-5 uppercase bg-appBlue text-appGray2 text-[12px] tracking-widest font-semibold w-full rounded drop-shadow-lg">
              place order
            </button>
          </div>
        </div>
